    ...
    <div style={{ marginLeft: "80px", minHeight: "100vh", background: "#0a0a0f", color: "white" }}>
      ...
      <div style={{ padding: "24px" }}>
        <div style={{ marginBottom: "24px" }}>
          ...
          {/* Add New Task */}
          <div style={{ background: "#121218", border: "1px solid #1f1f2e", borderRadius: "12px", padding: "16px", marginBottom: "24px" }}>
            <div style={{ display: "flex", gap: "12px" }}>
              <input
                ...
                style={{ flex: 1, background: "#0a0a0f", border: "1px solid #1f1f2e", borderRadius: "8px", padding: "12px", color: "white", fontSize: "14px", outline: "none" }}
              />
              <select
                value={newTaskPriority}
                onChange={(e) => setNewTaskPriority(e.target.value as Task["priority"])}
                style={{ background: "#0a0a0f", border: "1px solid #1f1f2e", borderRadius: "8px", padding: "12px", color: "white", fontSize: "14px", outline: "none" }}
              >
        ...
        <div style={{ position: "relative", maxWidth: "400px", marginBottom: "24px" }}>
          ...
          <input
            ...
            style={{ width: "100%", background: "#121218", border: "1px solid #1f1f2e", borderRadius: "12px", padding: "12px 12px 12px 44px", fontSize: "14px", color: "white", outline: "none" }}
          />
        </div>
            ...
            return (
              <div key={column.id} style={{ minWidth: "320px", flexShrink: 0 }}>
                <div style={{ display: "flex", alignItems: "center", gap: "10px", marginBottom: "16px" }}>
                  ...
                  <span style={{ fontSize: "12px", background: "#121218", padding: "4px 10px", borderRadius: "6px", color: "#9ca3af" }}>{columnTasks.length}</span>
                </div>

                <div style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
                  {columnTasks.map((task) => (
                    <div key={task.id} style={{ background: "#121218", border: "1px solid #1f1f2e", borderRadius: "12px", padding: "16px" }}>
                  ...
                  {columnTasks.length === 0 && (
                    <div style={{ background: "#0a0a0f", border: "2px dashed #1f1f2e", borderRadius: "12px", padding: "32px", textAlign: "center", color: "#4a4a6a", fontSize: "13px" }}>
                      No tasks
                    </div>
                  )}
                </div>
