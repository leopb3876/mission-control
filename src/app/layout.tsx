...
function Sidebar() {
  return (
    <aside className="sidebar-desktop" style={{ width: "180px", background: "var(--card)", borderRight: "1px solid var(--border)", padding: "16px", display: "flex", flexDirection: "column", position: "fixed", left: 0, top: 0, height: "100vh", zIndex: 50 }}>
